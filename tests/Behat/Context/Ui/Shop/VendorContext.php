...
final class VendorContext implements Context
{
     ...
     */
    public function iWantToListVendors()
    {
        $this->indexPage->open();
    }
     ...
     */
    public function iShouldSeeVendorsOnThePage($pagesNumber)
    {
     ...
     * @throws \FriendsOfBehat\PageObjectExtension\Page\UnexpectedPageException
     */
    public function iGoToThePage($slug)
    {
     ...
     * @throws \Behat\Mink\Exception\ElementNotFoundException
     */
    public function iShouldSeeAPageWithName($name)
    {
